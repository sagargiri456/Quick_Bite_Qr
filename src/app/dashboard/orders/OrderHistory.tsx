                ...
                <tbody>
                  {isLoading ? (
                    ...
                    filteredOrders.map((order: any, index: number) => (
                      <tr key={order.id} className={`border-b hover:bg-slate-50/50 transition-colors ${index % 2 === 0 ? "bg-white" : "bg-slate-25"}`}>
                        <td className="p-4 font-mono text-slate-800">{order.id}</td>
                        <td className="p-4">
                          <Badge variant="outline" className="font-mono">{order.table_id}</Badge>
                        </td>
                        <td className="p-4 font-semibold text-green-600">${order.total_amount.toFixed(2)}</td>
                        <td className="p-4">
