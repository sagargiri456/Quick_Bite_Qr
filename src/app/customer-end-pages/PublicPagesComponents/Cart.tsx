...
import { toast } from 'sonner'; // ADDED: Import toast for notifications
...
        clearCart();
        toast.success("Order placed successfully!"); // ADDED: Success toast
        router.push(`/customer-end-pages/${slug}/orders/${trackCode}`);
        return;
      }
      // CHANGED: Replaced alert with toast
